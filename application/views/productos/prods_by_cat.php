			...
			<div class="col-md-4">
				<div class="card producto">
					...
					<div class="card-block">
						...
						<?php if ($prod['stock']): ?>
							<a href="<?php echo base_url("index.php/carrito/anadir/$prod[id]") ?>" class="btn btn-primary btn-block boton"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Añadir al carrito</a>
						<?php endif ?>
					</div>
				</div>
			</div>
